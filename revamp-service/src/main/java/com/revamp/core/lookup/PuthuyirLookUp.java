...
BATHROOM ( "asset", "bathroom", "Bathroom", "assettype", "infrastructure"),
 ...
 PROJECT_CANCELLED ( "projectstatus", "projectCancelled", "ProjectCancelled", "null", "null"),
    ADMIN_REVIEWED ( "projectstatus", "AdminReviewed", "AdminReviewed", "null", "null"),
    REVIEWER_CONFIRMED ( "projectstatus", "ReviewerConfirmed", "ReviewerConfirmed", "null", "null"),
    APPROVED_SCHOOL ( "projectstatus", "ApprovedSchool", "ApprovedSchool", "null", "null"),
    ADMIN_REJECTED ( "projectstatus", "AdminRejected", "AdminRejected", "null", "null"),
     REVIEWER_REJECTED ( "projectstatus", "ReviewerRejected", "ReviewerRejected", "null", "null"),
    APPROVER_REJECTED ( "projectstatus", "ApproverRejected", "ApproverRejected", "null", "null"),
